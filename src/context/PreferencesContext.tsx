...
export interface Translations {
  ...
  androidStep1: string;
  gotItBtn: string;diabeteasyPromoTitle: string; diabeteasyPromoText: string; diabeteasyPromoLink: string;diabeteasyPromoTitle: string; diabeteasyPromoText: string; diabeteasyPromoLink: string;
}
